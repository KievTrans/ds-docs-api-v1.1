...
**Date: April 30th , 2023 – API version 1.1**

Based on PSP request, from version 1.1 all requests must include the payer’s name details. See `client_private_name` and `client_family_name` fields added to the API.
